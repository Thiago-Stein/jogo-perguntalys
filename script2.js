...
const corpoFase = document.getElementById('corpo-fase2');

const respostaCorreta = 5;
const proximaPagina = 'index3.html';
...
const botaoDica = document.getElementById('botaoDica2');
const mensagemDica = document.getElementById('mensagemDica2');

const dicaFase1 = "Descubra o valor de ▲ primeiro.";
