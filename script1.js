...
const corpoFase = document.getElementById('corpo-fase');

const faseAtual = 1;
const respostaCorreta = 8;
const proximaPagina = 'index2.html';
...
const dicaFase1 = "Cada número é a soma dos dois anteriores.";
