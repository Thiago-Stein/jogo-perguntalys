...
const corpoFase = document.getElementById('corpo-fase4');

const faseAtual = 4;
const respostaCorreta = 5;
const proximaPagina = 'index5.html';
...
const botaoDica = document.getElementById('botaoDica4');
const mensagemDica = document.getElementById('mensagemDica4');

const dicaFase1 = "Pense em como o formato muda.";
